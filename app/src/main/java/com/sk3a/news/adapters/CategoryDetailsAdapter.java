...
public class CategoryDetailsAdapter extends RecyclerView.Adapter<CategoryDetailsAdapter.WallpaperViewHolder> {
    ...
    public CategoryDetailsAdapter(Context mCtx, List<News> categoryList) {
        this.mCtx = mCtx;
